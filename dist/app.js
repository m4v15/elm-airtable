...
var _user$project$Models$initialModel = function (route) {
	return {
		...
		route: route,
		newPlayer: {id: '27', name: '', level: 0}
	};
};
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {players: a, route: b, newPlayer: c};
	});
...
var _user$project$Models$AddPlayerRoute = {ctor: 'AddPlayerRoute'};
...
var _user$project$Msgs$OnPlayerDelete = function (a) {
	return {ctor: 'OnPlayerDelete', _0: a};
};
var _user$project$Msgs$DeletePlayer = function (a) {
	return {ctor: 'DeletePlayer', _0: a};
};
var _user$project$Msgs$OnPlayerAdd = function (a) {
	return {ctor: 'OnPlayerAdd', _0: a};
};
var _user$project$Msgs$AddPlayer = {ctor: 'AddPlayer'};
var _user$project$Msgs$NewLevel = F2(
	function (a, b) {
		return {ctor: 'NewLevel', _0: a, _1: b};
	});
var _user$project$Msgs$NewName = F2(
	function (a, b) {
		return {ctor: 'NewName', _0: a, _1: b};
	});
var _user$project$Msgs$ChangeName = F2(
	function (a, b) {
...
var _user$project$Commands$editPlayerUrl = function (playerId) {
	return A2(
		...
		_user$project$Commands$basePlayersUrl,
		A2(_elm_lang$core$Basics_ops['++'], '/', playerId));
};
...
var _user$project$Commands$methodPlayerRequest = F3(
	function (method, url, player) {
		return _elm_lang$http$Http$request(
			{
...
var _user$project$Commands$savePlayerCmd = function (player) {
	return A2(
		...
		A3(
			_user$project$Commands$methodPlayerRequest,
			'PUT',
			_user$project$Commands$editPlayerUrl(player.id),
			player));
};
var _user$project$Commands$addPlayerCmd = function (player) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msgs$OnPlayerAdd,
		A3(_user$project$Commands$methodPlayerRequest, 'POST', _user$project$Commands$basePlayersUrl, player));
};
var _user$project$Commands$deletePlayerCmd = function (player) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Msgs$OnPlayerDelete,
		A3(
			_user$project$Commands$methodPlayerRequest,
			'DELETE',
			_user$project$Commands$editPlayerUrl(player.id),
...
var _user$project$Commands$fetchPlayers = A2(
	...
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Commands$basePlayersUrl, _user$project$Commands$playersDecoder)));

var _user$project$Routing$playerPath = function (id) {
	return A2(_elm_lang$core$Basics_ops['++'], '#players/', id);
};
var _user$project$Routing$addPath = '#add';
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Models$AddPlayerRoute,
...
var _user$project$Update$updatePlayer = F2(
	function (model, newPlayer) {
		var pick = function (currentPlayer) {
			return _elm_lang$core$Native_Utils.eq(newPlayer.id, currentPlayer.id) ? newPlayer : currentPlayer;
		};
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'NewName':
				var playerToAdd = _elm_lang$core$Native_Utils.update(
					_p0._0,
					{name: _p0._1});
				return {
					ctor: '_Tuple2',
			...
			case 'AddPlayer':
				var oldNewPlayer = model.newPlayer;
				var newNewPlayer = _elm_lang$core$Native_Utils.update(
					oldNewPlayer,
					{
						id: A2(_elm_lang$core$Basics_ops['++'], oldNewPlayer.id, '1')
					});
				...
				return {
					ctor: '_Tuple2',
					_0: newModel,
					_1: _user$project$Commands$addPlayerCmd(model.newPlayer)
				};
			case 'OnPlayerAdd':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{route: _user$project$Models$PlayersRoute}),
			...
			case 'DeletePlayer':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Commands$deletePlayerCmd(_p0._0)
				};
			default:
...
var _user$project$Players_List$deleteBtn = function (player) {
	return A2(
				...
				_elm_lang$html$Html$i,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Msgs$DeletePlayer(player)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
...
var _user$project$Players_List$addBtn = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('btn regular right p1'),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(_user$project$Routing$addPath),
			_1: {ctor: '[]'}
		}
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('fa fa-plus-circle m1'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}),
		_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$Players_List$deleteBtn(player),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Players_List$nav = A2(
	...
	},
	{
		...
		_1: {
			ctor: '::',
			_0: _user$project$Players_List$addBtn,
			_1: {ctor: '[]'}
		}
	});
...
var _user$project$Players_Edit$listBtn = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('btn regular left p2'),
		_1: {
			ctor: '::',
			...
			_0: A2(
				_elm_lang$html$Html$i,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							A2(_user$project$Msgs$ChangeLevel, player, 1)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
...
var _user$project$Players_Edit$nav = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('clearfix mb2 white bg-black'),
...
var _user$project$Players_Edit$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Players_Edit$nav,
			_1: {
				ctor: '::',
...
var _user$project$Players_Add$addForm = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(
								_user$project$Msgs$NewName(model.newPlayer)),
							_1: {ctor: '[]'}
						}
					}
				},
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Level'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(
									_user$project$Msgs$NewLevel(model.newPlayer)),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Msgs$AddPlayer),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Players_Add$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Players_Add$addForm(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$View$page = function (model) {
	...
	switch (_p2.ctor) {
		...
		case 'AddPlayerRoute':
			return _user$project$Players_Add$view(model);
		default:
			return _user$project$View$notFoundView;
	}
};
